    ...
    def draw_maze(self, current_cell=None, backtracked_cell=None):
        ...
        for x in range(self.width):
            for y in range(self.height):
                ...
                if cell.walls["right"]:
                    pygame.draw.line(screen, (0, 0, 0), ((x + 1) * CELL_SIZE, y * CELL_SIZE),
                                     ((x + 1) * CELL_SIZE, (y + 1) * CELL_SIZE))
                if cell.walls["bottom"]:
                    pygame.draw.line(screen, (0, 0, 0), (x * CELL_SIZE, (y + 1) * CELL_SIZE),
                                     ((x + 1) * CELL_SIZE, (y + 1) * CELL_SIZE))
                if cell.walls["left"]:
                    pygame.draw.line(screen, (0, 0, 0), (x * CELL_SIZE, y * CELL_SIZE),
        ...
        if backtracked_cell:
            ...
            backtracked_cell.x * CELL_SIZE + MARGIN, backtracked_cell.y * CELL_SIZE + MARGIN, CELL_SIZE - 2 * MARGIN,
            CELL_SIZE - 2 * MARGIN))
